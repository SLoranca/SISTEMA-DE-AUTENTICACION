...
//REVISAR TODAVIA NO CARGA LA IMAGEN EN LA BARRA
//CARGA LA IMAGEN EN EL MODULO DE PROFILE Y BARRA LATERAL IZQ
function loadImg(user_id) {
    _app.select.user_id = user_id;
    let img = localStorage.getItem("data-photo");
    if (img != "") {
        document.getElementById("imgProfile").src = "";
        document.getElementById("imgProfile").src = _app.srcImg + "img" + "/" + user_id + "/" + img;
    }
    else {
        document.getElementById("imgProfile").src = photo_identity;
    }
}